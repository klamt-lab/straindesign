...
se = read_sbml_model('C:/Users/Philipp/Documents/Python/straindesign/examples/SmallExample.sbml')
# se = read_sbml_model('/scratch/Python/straindesign/examples/SmallExample.sbml')
results = yopt(se,obj_num='R3',obj_den='R1',constraints='R2=0',obj_sense='maximize')
print(results)
