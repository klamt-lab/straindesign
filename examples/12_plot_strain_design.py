...
constraints = ['NADTRHD = 0', 'NADH16 = 0', 'LDH_D = 0', 'PPC = 0']
...
ani = animation.FuncAnimation(plot2.figure, animate, save_count=360)

print('writing to file')

writer = animation.FFMpegWriter(fps=25, bitrate=1000)
