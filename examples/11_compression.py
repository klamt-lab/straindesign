...
models = ['e_coli_core','straindesign/examples/ECC2.sbml','iJO1366','iML1515','iJN746','iJN1463','iMM904',
          'straindesign/examples/yeast-GEM.xml', 'iMM1415','iCHOv1','Recon3D']
comp_no = ['number of model reactions','1 after removing blocked','2 after EFM compression','3 after parallel compression',
           '3 after EFM compression','4 after parallel compression','5 after EFM compression','6 after parallel compression',
           '7 after EFM compression','8 after parallel compression','9 after EFM compression','10 after parallel compression',
           '11 after EFM compression','12 after parallel compression','13 after EFM compression','14 after parallel compression',]
...
for i,model_name in enumerate(models):
    ...
    print('  Removed blocked reactions ('+str(len(model.reactions))+' reactions).')
