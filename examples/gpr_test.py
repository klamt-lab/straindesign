...
# specify modules
modules  = [mcs.SD_Module(network,"mcs_lin",module_sense="undesired",constraints=["rd_ex >= 1"])]
modules += [mcs.SD_Module(network,"mcs_lin",module_sense="desired",constraints=["r_bm >= 1"])]
...
M=None
# construct MCS MILP
mcsEnum = mcs.StrainDesigner(network,modules, max_cost=maxCost,\
