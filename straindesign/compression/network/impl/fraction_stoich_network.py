...
from .default_metabolic_network import DefaultMetabolicNetwork

if TYPE_CHECKING:
    from ...smx.iface.bigint_rational_matrix import BigIntegerRationalMatrix
    from ...smx.iface.readable_bigint_rational_matrix import ReadableBigIntegerRationalMatrix
    from ...efm_math.big_fraction import BigFraction
